...
rows1.push(itemRow('5', '事業規模：', false, '―　ヶ月', '＠0', '0', '4,000万円想定',
  ['年商 4,000 万円（年商5,000万円未満は＠0円、5,000万円超から5,000万円ごとに＠5,000）',
   '※5億円超は一律（+50,000円）']));

rows1.push(itemRow('6', '報酬支払：口座振替以外＠3,000　※請求書発行を行う場合',
  false, '―　ケ月', '3,000', '0', '口座振替'));

rows1.push(subtotalRow('税務業務　小計', '年額のみ　※3', '－', '225,000'));
