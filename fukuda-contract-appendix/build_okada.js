...
rows1.push(itemRow('', 'なお、年仕訳数1,201件～＠50にて別途請求', null, '', '', '', 'R8.2月期 2,541件／決算時に別途請求'));

rows1.push(itemRow('3', '資料預り、打合せ方法：', false, '―　ケ月', '5,000', '0', '来所・オンライン',
  ['訪問ありの場合は＠5,000', '来所・オンラインはゼロ']));

rows1.push(itemRow('4', '月次経理処理頻度：', true, '3　ケ月', '15,000', '45,000', '年6回超',
...
rows1.push(subtotalRow('税務業務　小計', '年額のみ　※4', '－', '285,000'));

rows1.push(itemRow('7', '決算報酬：法人 ＠120,000　個人＆NPO ＠50,000', true, '1　事業年度', '120,000', '120,000', '法人'));
rows1.push(itemRow('8', '消費税申告：＠50,000', false, '―　事業年度', '50,000', '0', '※6'));
...
rows1.push(itemRow('14', '税理士法第33条の2第1項に規定する書面添付', true, '1　事業年度', '30,000', '30,000', '※5'));

rows1.push(subtotalRow('決算・申告代行業務　小計', '年額のみ', '－', '150,000'));

rows1.push(totalRow('小　計（税抜）　　', '435,000'));
rows1.push(totalRow('消費税（10％）　　', '43,500'));
rows1.push(totalRow('お値引き（税込）　※7　　', '△141,900'));
...
rows3.push(subtotalRow('給与計算代行　小計', '年額のみ　※3', '－', '68,200'));

rows3.push(totalRow('小　計（税抜）　　', '68,200'));
rows3.push(totalRow('消費税（10％）　　', '6,820'));
rows3.push(totalRow('お値引き（税込）　※4　　', '－'));
rows3.push(totalRow('合　計（税込）　　', '75,020', { bold: true, shade: 'E6E6E6' }));
...
const NOTES1 = [
  ...
  '項目4の月次経理処理頻度は、見積書（見積番号20260725-004）の記載に従い数量3ケ月として算定している。月額単価×12か月ではないため、区分小計は年額のみを表示する。',
  ...
  'お値引きは、従前の顧問契約書（令和6年5月29日付。税務顧問報酬 月額 金28,050円（税込）。決算報酬及び書面添付を含む。）に基づく年額報酬 金336,600円（税込）に本別紙の合計額を据え置くための調整である。お値引き額は税抜 金129,000円（消費税額 金12,900円）に相当する。適用期間は別紙4第11条による。',
...
const NOTES3 = [
  ...
  '項目1の給与計算基本月額報酬は、見積書（見積番号20260725-004）の記載に従い数量1ヶ月として算定している。月額単価×12か月ではないため、区分小計は年額のみを表示する。',
...
const RATE_NOTES = [
  ...
  '記帳代行の仕訳数超過分の報酬は、当該事業年度の仕訳数が確定した後、決算時に一括して請求する。このため、別紙1には金額を記載しない。',
...
const besshi4 = [
  ...
  cl('2　本契約第2項に定める1事業年度あたり4,800仕訳を超える部分の単価は、1仕訳あたり￥50（税抜）とする。当該報酬は、当該事業年度の仕訳数が確定した後、決算時に一括して請求する。このため、別紙1には金額を記載しない。'),
