...
rows1.push(itemRow('5', '事業規模：', false, '―　ヶ月', '＠0', '0', '572万円想定　※3',
  ['年商 572 万円（年商5,000万円未満は＠0円、5,000万円超から5,000万円ごとに＠5,000）',
   '※5億円超は一律（+50,000円）']));

rows1.push(itemRow('6', '報酬支払：口座振替以外＠3,000　※請求書発行を行う場合',
  false, '―　ケ月', '3,000', '0', '口座振替'));

rows1.push(subtotalRow('税務業務　小計', '年額のみ　※4', '－', '225,000'));
...
rows1.push(totalRow('小　計（税抜）　　', '345,000'));
rows1.push(totalRow('消費税（10％）　　', '34,500'));
rows1.push(totalRow('お値引き（税込）　※6　　', '△42,900'));
...
const NOTES1 = [
  ...
  '項目5の年商は、甲を貸主とする賃貸借契約3件（土地〔与六分136番地1〕月額70,000円、建物・駐車場〔与六分136番地3〕第2期間 月額 屋内駐車場4台120,000円・屋外駐車場3台30,000円・建物210,000円（税抜）、社宅〔与六分131番地11〕月額60,000円）に基づき、令和8年2月期末時点の契約条件が12か月継続するものとして試算した年額（税抜）である。5,000万円未満のため事業規模による加算は行わない。',
  ...
  'お値引きは、従前の顧問契約書（令和6年5月29日付。税務顧問報酬 月額 金28,050円（税込）。決算報酬及び書面添付を含む。）に基づく年額報酬 金336,600円（税込）に本別紙の合計額を据え置くための調整である。お値引き額は税抜 金39,000円（消費税額 金3,900円）に相当する。適用期間は別紙4第11条による。',
