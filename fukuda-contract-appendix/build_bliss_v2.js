...
rows1.push(itemRow('12', 'NXPRO使用　決算手数料：年間△50,000（ミロクのクラウドアプリを使用している場合）',
  false, '―　事業年度', '△50,000', '0'));
rows1.push(itemRow('13', '出精値引き', false, '―　事業年度', '△', '0'));
...
rows1.push(totalRow('お値引き（税込）　　', '0'));
rows1.push(totalRow('合　計（税込）　　', '1,315,875', { bold: true, shade: 'E6E6E6' }));
...
rows3.push(totalRow('合　計（税込）　　', '408,540', { bold: true, shade: 'E6E6E6' }));
