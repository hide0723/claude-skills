...
福田会計の事業計画書PPTを、**アチーブ質問票**の体系に沿ってAsanaの進捗と連携しながら毎日更新するスキル。更新後はユーザーが手動でメール送信する。

**アチーブ質問票の体系：**
- Ⅰ．人生理念／ビジョン（アファメーション積極宣言8項目）※Notion
- Ⅱ．重点目標 ※Notion
- Ⅲ．中長期・年間行動計画
- 個別戦略5領域：教育・採用／サービス品質／営業・マーケティング／戦略構築・商品開発／財務体質 ※Asana

**機能：**
- Asanaプロジェクト『02.福田会計 目標設定／計画立案』からセクション別に進捗を集計
- 「緊急×重要」カスタムフィールドから今月の重点アクションを抽出
- 事業計画書PPTの各戦略スライドを進捗データで更新・保存

**使用技術：**
- python-pptx（PPT操作）
- Asana REST API（セクション別集計・カスタムフィールド）
- Notion MCP（人生理念・重点目標の参照）
