...
{grades_tbl}
    <p class="lead" style="margin-top:1.2rem">期待売上高＝そのグレードの基本給上限 × 2 × 1.3 × 1.15 × 14（千円未満切上）。D（拠点長）以上は個人の期待売上高を置かず、組織運営と給与総額比率で見ます。各職階の「昇格の条件」は職階をまたぐときの判定です。同じ職階の中のグレード上げ（例：S3→S4）の基準は、この表にはまだありません。</p>
  </div>
</section>
